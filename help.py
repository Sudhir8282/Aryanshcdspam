...
PythonHelp = f"★ ​𓆩𝗖𝗗𓆪 𝗦𝗽𝗮𝗺𝗲𝗿 𝙃𝙚𝙡𝙥 𝙈𝙚𝙣𝙪 ★\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟʟᴏᴡ ʙᴜᴛᴛᴏɴs ᴛᴏ ʟᴇᴀʀɴ ᴛᴏ ᴜsᴇ 𓆩𝗖𝗗𓆪 𝗦𝗽𝗮𝗺𝗲𝗿 ʙᴏᴛ **\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: @cyberdragon2477**"
...
async def help(event):
    if event.sender_id in SUDO_USERS:
       await event.client.send_file(event.chat_id,
           ...
           [    
            Button.url("• ᴄʜᴀɴɴᴇʟ •", "https://t.me/cyberdragons47"),
            Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://t.me/CYBERDRAGONCLUB")
           ],
           ],
           )
...
async def helpback(event):
   if event.query.user_id in SUDO_USERS:    
      await event.edit(
           ...
           [
            Button.url("• ᴄʜᴀɴɴᴇʟ •", "https://t.me/cyberdragon47"),
            Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://t.me/cyberdragonclub")
           ],
           ],
        )           
   else:
        await event.answer("join @cyberdragon47 and ask any admin for sudo😌", cache_time=0, alert=True)
