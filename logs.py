...
async def logs(legend):
    if legend.sender_id == OWNER_ID:
        ...
        logfile.write("⚡ ᴄʏʙᴇʀᴅʀᴀɢᴏɴ ʙᴏᴛ ⚡ [ BotSpam Logs ]\n\n" + logs)
        logfile.close()
        await MK1.send_file(legend.chat_id, "skspam.txt", caption=f"⚡ ​ᴄʏʙᴇʀᴅʀᴀɢᴏɴ ʙᴏᴛ ⚡\n  » **ᴛɪᴍᴇ ᴛᴀᴋᴇɴ:** `{ms} ꜱᴇᴄᴏɴᴅꜱ`")
    else:
        await legend.reply("» ꜱᴏʀʀʏ, ᴏɴʟʏ ᴍʏ ᴍᴀsᴛᴇʀ ᴄᴀɴ ᴀᴄᴄᴇꜱꜱ ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ.")
