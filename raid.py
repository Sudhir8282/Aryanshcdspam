...
async def spam(e):
    ...
    if e.sender_id in SUDO_USERS:
        ...
        if len(mkraid) == 2:
            ...
            g = a.id
            if int(g) in ALTRON:
                await e.reply("» ᴍᴀᴅᴀʀᴄʜᴏᴅ ᴋɪ ᴀᴜʟᴀᴅ ᴛᴇʀᴀ ʙᴀᴀᴘ ʜᴀɪ ʏᴇ ᴇsᴘʀ ʀᴀɪᴅ ᴅᴀʟɴᴇ ᴋɪ ᴀᴜᴋᴀᴛ ɴʜɪ", parse_mode=None, link_preview=None)
            elif int(g) in SUDO_USERS:
                await e.reply("» ᴊɪᴛɴɪ ᴛᴇʀɪ ᴀᴜᴋᴀᴛ ʜᴀɪ ᴜᴛɴɪ ʜɪ ᴇsᴋɪ ʙʜɪ ʜᴀɪ sᴜᴅᴏ ʟᴇᴋʀ ʙᴇᴛʜᴀ ʜᴀɪ ʏᴇ ʙʜɪ", parse_mode=None, link_preview=None)
            else:
                c = a.first_name
            ...
            g = b.id
            if int(g) in ALTRON:
                await e.reply("» ᴍᴀᴅᴀʀᴄʜᴏᴅ ᴋɪ ᴀᴜʟᴀᴅ ᴇsᴘʀ ʀᴀɪᴅ ᴅᴀʟɴᴇ ᴋɪ ᴀᴜᴋᴀᴛ ɴʜɪ ᴛᴇʀɪ", parse_mode=None, link_preview=None)
            elif int(g) in SUDO_USERS:
                await e.reply("» ᴇsᴋɪ ᴀᴜᴋᴀᴛ ʙʜɪ ᴛᴇʀɪ ᴊɪᴛɴɪ ʜɪ ʜᴀɪ ʏᴇ ᴠ sᴜᴅᴏ ʟᴇᴋʀ ʙᴇᴛʜᴀ ʜᴀɪ", parse_mode=None, link_preview=None)
            else:
                c = b.first_name
                counter = int(mkraid[0])
                username = f"[{c}](tg://user?id={g})"
    ...
    if e.sender_id in SUDO_USERS:
        ...
        if len(e.text) > 11:
            ...
            if int(user_id) in ALTRON:
                await e.reply("» ᴍᴀᴅᴀʀᴄʜᴏᴅ ᴇsᴘʀ ʀᴀɪᴅ ᴅᴀʟɴᴇ ᴋɪ ᴀᴜᴋᴀᴛ ɴʜɪ ᴛᴇʀɪ", parse_mode=None, link_preview=None)
            elif int(user_id) == OWNER_ID:
                await e.reply("» ᴍᴀᴅᴀʀᴄʜᴏᴅ ᴇsᴘʀ ʀᴀɪᴅ ᴅᴀʟɴᴇ ᴋɪ ᴀᴜᴋᴀᴛ ɴʜɪ ʜᴀɪ ᴛᴇʀɪ", parse_mode=None, link_preview=None)
            elif int(user_id) in SUDO_USERS:
                await e.reply("» ᴇsᴋɪ ʙʜɪ ᴀᴜᴋᴀᴛ ʙʜɪ ᴛᴇʀɪ ᴊɪᴛɴɪ ʜɪ ʜᴀɪ", parse_mode=None, link_preview=None)
            else:
                que[user_id] = []
                gey = que.get(user_id)
                phucker = [user_id]
                gey.append(phucker)
                await e.reply("» ᴏᴋ ᴄᴏᴍᴍᴀɴᴅᴇʀ ᴀʙ ᴇsᴋᴇ ʜʀ ᴍᴇssᴀɢᴇ ᴘʀ ᴇsᴋᴏ ɢᴀʟɪ ᴅᴜɴɢᴀ ʜᴇʜᴇ😋 !! ✅", parse_mode=None, link_preview=None)
            ...
            user_id = int(b.id)
            if int(user_id) in ALTRON:
                await e.reply("» ᴍᴀᴅᴀʀᴄʜᴏᴅ ᴋɪ ᴀᴜʟᴀᴅ ᴇsᴘʀ ʀᴀɪᴅ ᴅᴀʟɴᴇ ᴋɪ ᴛᴇʀɪ ᴀᴜᴋᴀᴛ ɴʜɪ", parse_mode=None, link_preview=None)
            elif int(user_id) == OWNER_ID:
                await e.reply("» ᴍᴀᴅᴀʀᴄʜᴏᴅ ᴋɪ ᴀᴜʟᴀᴅ ᴇsᴘʀ ʀᴀɪᴅ ᴅᴀʟɴᴇ ᴋɪ ᴛᴇʀɪ ᴀᴜᴋᴀᴛ ɴʜɪ ʜᴀɪ", parse_mode=None, link_preview=None)
            elif int(user_id) in SUDO_USERS:
                await e.reply("» ᴇsᴋɪ ᴀᴜᴋᴀᴛ ʙʜɪ ᴛᴇʀɪ ᴊɪᴛɴɪ ʜɪ ʜᴀɪ ʏᴇ ᴠ sᴜᴅᴏ ʟᴇᴋʀ ʙᴇᴛʜᴀ ʜᴀɪ", parse_mode=None, link_preview=None)
            else:
                que[user_id] = []
