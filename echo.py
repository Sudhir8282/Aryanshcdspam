  ...
  if event.sender_id in SUDO_USERS:
     if event.reply_to_msg_id is not None:
        ...
        if int(user_id) in ALTRON:
            await event.reply("» ᴍᴀᴅᴀʀᴄʜᴏᴅ ᴋɪ ᴀᴜʟᴀᴅ ᴇsᴘʀ ʀᴀɪᴅ ᴍʀɴᴇ ᴋɪ ᴀᴜᴋᴀᴛ ɴʜɪ ᴛᴇʀɪ", parse_mode=None, link_preview=None)
        elif int(user_id) == OWNER_ID:
            await event.reply("» ᴍᴀᴅᴀʀᴄʜᴏᴅ ᴋɪ ᴀᴜʟᴀᴅ ᴇsᴘʀ ʀᴀɪᴅ ᴍʀɴᴇ ᴋɪ ᴀᴜᴋᴀᴛ ɴʜɪ ᴛᴇʀɪ", parse_mode=None, link_preview=None)
        elif int(user_id) in SUDO_USERS:
            await event.reply("» ɢɴᴅᴜ ᴇsᴋɪ ᴀᴜᴋᴀᴛ ʙʜɪ ᴛᴇʀɪ ᴊɪᴛɴɪ ʜɪ ʜᴀɪ ʏᴇ ʙʜɪ sᴜᴅᴏ ʟᴇᴋʀ ʙᴇᴛʜᴀ ʜᴀɪ", parse_mode=None, link_preview=None)
        else:
            ...
            if is_echo(user_id, chat_id):
                await event.reply("» ᴇᴄʜᴏ ᴘᴇʜʟᴇ sᴇ ʟɢᴀ ʀᴋʜᴀ !!")
                return
            addecho(user_id, chat_id)
            await event.reply("» ᴇᴄʜᴏ ᴀᴘᴘʟɪᴇᴅ ᴏɴ ʏᴏᴜʀ ᴛᴀʀɢᴇᴛ ʙᴏss!! ✅")
     else:
  ...
  if event.sender_id in SUDO_USERS:
     if event.reply_to_msg_id is not None:
        ...
        if is_echo(user_id, chat_id):
            ...
            await event.reply("» ᴛʜɪᴋ ʜᴀɪ ʙᴏss ᴀʙ ᴛɴɢ ɴᴀ ᴋʀᴜɴɢᴀ ɪsᴇ ᴇᴄʜᴏ sᴇ🙄 ☑️")
        else:
            await event.reply("» ᴇᴄʜᴏ ʜᴛ ᴛᴏʜ ɢʏᴀ ᴀʙ ᴋʏᴀ ᴄʜᴀʜᴛᴇ ʜᴏ?")
     else:
          await event.reply(usage)
